...
const StudyBuddyLogo: React.FC<StudyBuddyLogoProps> = ({ className = 'w-12 h-12' }) => (
  <svg viewBox="0 0 120 120" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M48 62C52 68 68 68 72 62" stroke="white" strokeWidth="3" strokeLinecap="round" />
    <path d="M35 78L60 68L85 78V95L60 105L35 95V78Z" fill="#e61e6e" fillOpacity="0.9" />

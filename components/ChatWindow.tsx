    ...
    >
      {messages.length === 0 && !streamingUserText && !streamingBotText && (
        <div className="flex flex-col items-center justify-center h-full text-center p-8 opacity-50">
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium max-w-xs">
      ...
      {messages.map((msg) => (
        ...
        >
          ...
          >
            ...
            <div
              className={`text-[10px] mt-2 font-black uppercase tracking-widest opacity-40 ${msg.role === MessageRole.USER ? 'text-right' : 'text-left'}`}
            >
